...
from view import bar_valores, inserir_categoria, inserir_gastos, inserir_receita, ver_categorias, tabela, deletar_gastos, deletar_receitas,  ver_gastos, ver_Receitas, percentagem_valor
...
def deletar_dados():
        try:
          ...
          if nome =='Receita':
               ...
               messagebox.showinfo('Sucesso', 'Receita Excluída')
              ...
              messagebox.showinfo('Erro', 'Seleciona um dos dados na tabela')
